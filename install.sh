...
REPO="https://api.github.com/repos/mixail090/podkop/releases/latest"
...
update_config() {
    ...
    printf "\033[48;5;196m\033[1m║ Подробности: https://github.com/mixail090/podkop                     ║\033[0m\n"
    ...
    printf "\033[48;5;196m\033[1m║ Details: https://github.com/mixail090/podkop                         ║\033[0m\n"
    ...
    while true; do
            ...
            yes|y|Y)
                ...
                wget -O /etc/config/podkop https://raw.githubusercontent.com/mixail090/podkop/refs/heads/main/podkop/files/etc/config/podkop
...
main() {
    ...
    if command -v curl >/dev/null 2>&1; then
        check_response=$(curl -s "https://api.github.com/repos/mixail090/podkop/releases/latest")
